 ...
 * conversion happens here (mirrors the decisions/_components copy used by
 * task 09). Only the safe, renderable fields are copied — never secrets,
 * tokens, or raw command output.
 */
